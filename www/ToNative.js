...
function onInitializeFailed(error) {
    var message = "Unable to initialize the Ace plugin: " + error +
        ". The most common reason is that <feature name=\"NativeHost\">...</feature> is missing from the copy of config.xml in the platforms directory. " +
