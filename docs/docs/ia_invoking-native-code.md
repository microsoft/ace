...
> Be sure to check out [the sample code](https://github.com/microsoft/ace/tree/master/examples) to see this in action
...
When you directly invoke native APIs, the code you write will be platform-specific. See [this topic](/ace/docs/platform-specific) for
details and strategies for writing platform-specific code.
